    ...
    <form action="<?= base_url($controller . "/insertData"); ?>" method="post" enctype="multipart/form-data">
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="time" class="form-control" id="mulai" placeholder="waktu" name="jam_masuk" required>
            </div>
            <div class="form-group">
                <label for="akhir">Waktu Berakhir</label>
                <input type="time" class="form-control" id="akhir" placeholder="waktu" name="jam_keluar" required>
            </div>
            <div class="form-group">
